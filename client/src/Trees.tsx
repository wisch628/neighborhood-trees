export const Trees = ({ fullWidth = 600 }: { fullWidth?: number }) => {
  ...
  return (
    <div className="treeWrapper">
      <img className="just-desktop" src="/tree-1.png" width={width} />
      <img src="/tree-2.png" width={width} />
      <img className="just-desktop" src="/tree-3.png" width={width} />
      <img src="/tree-4.png" width={width} />
      <img className="just-desktop" src="/tree-6.png" width={width} />
